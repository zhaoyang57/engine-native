...
SE_DECLARE_FUNC(js_video_VideoPlayer_enableProgressGesture);
SE_DECLARE_FUNC(js_video_VideoPlayer_setPlaybackRate);
SE_DECLARE_FUNC(js_video_VideoPlayer_setLive);
SE_DECLARE_FUNC(js_video_VideoPlayer_duration);
SE_DECLARE_FUNC(js_video_VideoPlayer_enableControls);
SE_DECLARE_FUNC(js_video_VideoPlayer_pause);
SE_DECLARE_FUNC(js_video_VideoPlayer_setPoster);
SE_DECLARE_FUNC(js_video_VideoPlayer_onPlayEvent);
SE_DECLARE_FUNC(js_video_VideoPlayer_addEventListener);
SE_DECLARE_FUNC(js_video_VideoPlayer_showCenterPlayBtn);
...
SE_DECLARE_FUNC(js_video_VideoPlayer_setMute);
